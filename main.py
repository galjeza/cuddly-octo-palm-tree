...
def main():
    ...
    mojtrg = driver.find_element(by=By.CLASS_NAME,value="mojtrg")
    ...
    for i in range(1,3):
        try:
            ...
            time.sleep(5)
            results = driver.find_elements(by=By.CLASS_NAME,value="ResultsAd")
